(function (a) {
    function m(f, c) {
        ...
        function l() {
            n.temp = aa && null !== n.val && n.val != G.val() || null === n.values ? p.parseValue(G.val() || "", n) : n
                .values.slice(0);
            ia()
        }
        ...
        function m(a, c, g, b, y) {
            ...
            k == ja[c] && ba[c] || (b && k != ja[c] && E("onAnimStart", [v, c, b]), ja[c] = k, h[D + "Transition"] =
                "all " + (b ? b.toFixed(3) : 0) + "s ease-out", x ? h[D + "Transform"] = "translate3d(0," + k + "px,0)" :
                h.top = k + "px", ba[c] && t(a, c), b && y && (a.closest(".dwwl").addClass("dwa"), ba[c] = setTimeout(function () {
                t(a, c)
            }, 1E3 * b)), ea[c] = g)
        }
        function K(c, g, b, k, y) {
            !1 !== E("validate", [v, g, c]) && (a(".dw-ul", v).each(function (b) {
                ...
                if (!e.hasClass("dw-v")) {
                    ...
                    (l < d && l && 2 !== k || !d || 0 > f - d || 1 == k) && e.hasClass("dw-v") ? f += l : (e = o, f -=
                        d)
                }
                if (!e.hasClass("dw-sel") || I) n.temp[b] = e.attr("data-val"), a(".dw-sel", h).removeClass("dw-sel"),
                        p.multiple || (a(".dw-sel", h).removeAttr("aria-selected"), e.attr("aria-selected", "true")), e
                        .addClass("dw-sel"), m(h, b, f, I ? c : 0.1, I ? y : !1)
            }), R = p.formatResult(n.temp), "inline" == p.display ? ia(b, 0, !0) : a(".dwv", v).html(d(R)), b && E(
                "onChange", [R]))
        }
        function E(g, b) {
            var k;
        ...
        var na,
            ...
            W = !1,
            Fa = function (c) {
                z(c) && !e && !k(this) && !V && (c.preventDefault(), e = !0, fa = "clickpick" != p.mode, L = a(".dw-ul",
                    this), h(L), ga = (ta = void 0 !== ba[M]) ? r(L) : ea[M], X = A(c, "Y"), Ba = new Date, U = X, m(L,
                    M, ga, 0.0010), fa && L.closest(".dwwl").addClass("dwa"), a(document).on(u, Ca).on(w, Da))
            }, Ca = function (a) {
        ...
        n.position = function (c) {
            if (!("inline" == p.display || S === a(window).width() && ra === a(window).height() && c || !1 === E(
                "onPosition", [v]))) {
                ...
                P = j.outerHeight(!0);
                sa = P <= O && ca <= S;
                "modal" == p.display ? (g = (S - ca) / 2, k = c + (O - P) / 2) : "bubble" == p.display ? (n = !0, i = a(
                    ".dw-arrw-i", v), g = e.offset(), h = g.top, f = g.left, y = e.outerWidth(), e = e.outerHeight(), g =
                    f - (j.outerWidth(!0) - y) / 2, g = g > S - ca ? S - (ca + 20) : g, g = 0 <= g ? g : 20, k = h - P,
                    k < c || h > c + O ? (j.removeClass("dw-bubble-top").addClass("dw-bubble-bottom"), k = h + e) : j.removeClass(
                    "dw-bubble-bottom").addClass("dw-bubble-top"), i = i.outerWidth(), y = f + y / 2 - (g + (ca - i) /
                    2), a(".dw-arr", v).css({
                    left: Math.max(0,
                        Math.min(y, i))
        ...
        n.show = function (c) {
            ...
            var b, g = 0,
                k = "";
            T && !c && (k = "dw-" + T + " dw-in");
            var h = '<div role="dialog" class="' + p.theme + " dw-" + p.display + (Q ? " dw" + Q : "") + '">' + (
                "inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr">' :
                '<div class="dw-persp"><div class="dwo"></div><div class="dw dwbg ' +
                k +
                '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div aria-live="assertive" class="dwv' +
                (p.headerText ? "" : " dw-hidden") + '"></div>') + '<div class="dwcc">';
            a.each(p.wheels, function (c, k) {
                h += '<div class="dwc' + ("scroller" != p.mode ? " dwpm" : " dwsc") + (p.showLabel ? "" : " dwhl") +
                ...
                a.each(k, function (a, c) {
                    ...
                    h += '<td><div class="dwwl dwrc dwwl' + g + '">' + ("scroller" !=
                        p.mode ? '<div class="dwb-e dwwb dwwbp" style="height:' + H + "px;line-height:" + H +
                        'px;"><span>+</span></div><div class="dwb-e dwwb dwwbm" style="height:' + H + "px;line-height:" +
                        H + 'px;"><span>–</span></div>' : "") + '<div class="dwl">' + b +
                        '</div><div tabindex="0" aria-live="off" aria-label="' + b +
                        '" role="listbox" class="dwww"><div class="dww" style="height:' + (p.rows * H-100) + "px;min-width:" +
                        p.width + 'px;"><div class="dw-ul">';
                    h += y(g);
                    h +=
                        '</div><div class="dwwol"></div></div><div class="dwwo"></div></div><div class="dwwol"></div></div></td>';
                    g++
                });
                h += "</tr></table></div></div>"
            });
            h += "</div>" + ("inline" != p.display ? '<div class="dwbc' + (p.button3 ? " dwbc-p" : "") +
                '"><span class="dwbw dwb-s"><span class="dwb dwb-e" role="button" tabindex="0">' + p.setText +
                "</span></span>" + (p.button3 ?
                '<span class="dwbw dwb-n"><span class="dwb dwb-e" role="button" tabindex="0">' + p.button3Text +
                "</span></span>" : "") + '<span class="dwbw dwb-c"><span class="dwb dwb-e" role="button" tabindex="0">' +
                p.cancelText + "</span></span></div></div>" : "") + "</div></div></div>";
            v = a(h);
            K();
            E("onMarkupReady", [v]);
        ...
        n.hide = function (c, b) {
            ...
            a(".dwtd").each(function () {
                ...
                a(this).data("autocomplete") ? a(this).attr("autocomplete", a(this).data("autocomplete")) : a(this).removeAttr(
                    "autocomplete")
            });
    ...
    function l(a, c, b) {
        ...
        "string" === typeof c && a.each(function () {
            var a;
            if ((a = q[this.id]) && a[c]) if (a = a[c].apply(this, Array.prototype.slice.call(b, 1)), void 0 !== a)
                    return k = a, !1
        });
        return k
    }
        ...
        z = {
            ...
            if (J.match(/date/i)) {
                ...
                for (o = 0; 3 > o; o++) if (o == w.y) {
                    ...
                    x = [];
                    r = [];
                    for (b = 0; 12 > b; b++) A = c.replace(/[dy]/gi, "").replace(/mm/, 9 > b ? "0" + (b + 1) : b + 1).replace(
                            /m/, b + 1),
                    r.push(b), x.push(A.match(/MM/) ? A.replace(/MM/, '<span class="dw-mon">' + i.monthNames[b] +
                        "</span>") : A.replace(/M/, '<span class="dw-mon">' + i.monthNamesShort[b] + "</span>"));
                    e(q, r, x, i.monthText)
                } else if (o == w.d) {
                    C++;
                    x = [];
            ...
            if (J.match(/time/i)) {
                ...
                for (o = C; o < C + 4; o++) if (o == w.h) {
                        ...
                        x = [];
                        r = [];
                        for (b = 0; b < (h ? 12 : 24); b += da) r.push(b), x.push(h && 0 == b ? 12 : g.match(/hh/i) &&
                                10 > b ? "0" + b : b);
                        e(q, r, x, i.hourText)
                    } else if (o == w.i) {
                    C++;
                                ...
                                k && a(".dw-li", q).each(function () {
                                    var b = a(this),
                                        ...
                                        g = c.replace(/[my]/gi, "").replace(/dd/, g < 10 ? "0" + g :
                                            g).replace(/d/, g);
                                    a(".dw-i", b).html(g.match(/DD/) ? g.replace(/DD/, '<span class="dw-day">' + i.dayNames[
                                        k] + "</span>") : g.replace(/D/, '<span class="dw-day">' + i.dayNamesShort[k] +
                                        "</span>"))
                                })
                            }
    ...
    m.parseDate = function (d, l, e) {
        ...
        var l = "object" == typeof l ? l.toString() : l + "",
            ...
            D = function (a) {
                ...
                D(a);
                a = l.substr(u).match(RegExp("^\\d{1," + ("@" == a ? 14 : "!" == a ? 20 : "y" == a ? 4 : "o" == a ? 3 :
                    2) + "}"));
                if (!a) return 0;
                u += a[0].length;
                ...
                a = D(a) ? c : b;
                for (b = 0; b < a.length; b++) if (l.substr(u, a[b].length).toLowerCase() == a[b].toLowerCase()) return u +=
                            a[b].length, b + 1;
                return 0
            }, u = 0,
            w;
        ...
        100 > e && (e += (new Date).getFullYear() - (new Date).getFullYear() % 100 + (e <= ("string" != typeof s ? s :
            (new Date).getFullYear() % 100 + parseInt(s, 10)) ? 0 : -100));
        if (-1 < q) {
            o = 1;
            f = q;
            do {
    ...
    var m = a.mobiscroll,
        d = {
            ...
            var q = a.extend({}, m.settings),
                ...
                J = j(J, D);
            a("#" + Q).remove();
            b.showInput && (r = a('<input type="text" id="' + Q + '" value="" class="' + b.inputClass + '" readonly />')
                .insertBefore(q), m.settings.anchor = r, b.showOnFocus && r.focus(function () {
                m.show()
    ...
    a.mobiscroll.presets.select = function (d) {
        ...
        function F(a) {
            if (t && a.hasClass("dw-v") && a.closest(".dw").find(".dw-ul").index(a.closest(".dw-ul")) == u) {
                ...
                a.hasClass("dw-msel") ? (a.removeClass("dw-msel").removeAttr("aria-selected"), delete d._selectedValues[
                    b]) : (a.addClass("dw-msel").attr("aria-selected", "true"),
        ...
        return {
            ...
            validate: function (b, g, i) {
                if (g === void 0 && t) {
                    ...
                    for (h in l) a(".dwwl" + u + ' .dw-li[data-val="' + l[h] + '"]', b).addClass("dw-msel").attr(
                            "aria-selected", "true")
                }
                if (g === C) {
                    q = d.temp[C];
