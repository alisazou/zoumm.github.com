(function(b) {
	...
	var d = function(f, i, h) {
		...
		new e(f).loadend(function(p) {
			l._txtDom.innerHTML = this.percent
		}).complete(function() {
			l._loadDom.style.display = "none";
			m.apply(l)
		})
	};
